...
import { Plus, FolderOpen, Trash2, Image, Tag, Clock } from "lucide-react";
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Create tasks and annotate images for object detection
              </p>
            </div>
          </div>
        </div>
      ...
      <main className="max-w-5xl mx-auto px-6 py-8">
        ...
        <Card className="mb-8">
          <CardHeader>
            ...
            <CardDescription>
              Organize your annotations by creating separate tasks for different projects
            </CardDescription>
          </CardHeader>
          <CardContent>
